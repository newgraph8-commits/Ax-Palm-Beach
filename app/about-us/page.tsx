...
export const metadata = {
  title: "About Us - Ax Palm Beach",
  description: "Ax Palm Beach has quickly established itself as the new standard in executive search",
}
      ...
      <main className="bg-background">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                Ax Palm Beach has quickly established itself as the new standard in executive search—delivering
        ...
        <section className="py-16">
          ...
          >
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                Ax Palm Beach leads with a true partnership mindset, beginning every engagement with deep, active listening.
        ...
        <section className="py-16 bg-muted/30">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                At Ax Palm Beach, complacency is not an option. Our reputation rests on an unyielding commitment to
                executing every engagement with precision, discipline, and intensity. This operational mindset reflects
                the standards of elite military units: anticipate every scenario, prepare for every variable, and leave
                nothing to chance.
              </p>
              <p className="leading-relaxed">
                Even the strongest organizations encounter periods of volatility—whether financial, cultural, or social.
                Supported by a fortified infrastructure and a deeply experienced team, Ax Palm Beach is positioned to
        ...
        <section className="py-16">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                Executives who prioritize precision and strategic clarity increasingly turn to Ax Palm Beach, confident that
                ...
                positioned Ax Palm Beach as the definitive partner for this critical stage of organizational and
                professional advancement. The conclusion is simple: you shouldn't look elsewhere, you wouldn't consider
                it—and ultimately, you won't.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8 items-start">
              <div className="space-y-6 text-lg text-muted-foreground">
                <p className="leading-relaxed">
                  At the center of this advantage is Ax Palm Beach's proprietary A-Frame Intelligence Engine, a
        ...
        <section className="py-16 bg-muted/30">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                Surpassing the limits of traditional senior-leadership evaluation, Ax Palm Beach is equipped to execute
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  For example, in our growing education division, Ax Palm Beach maintains strong global relationships with
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ax Palm Beach's boutique model is built to drive impact—serving as a catalyst in some of the most
