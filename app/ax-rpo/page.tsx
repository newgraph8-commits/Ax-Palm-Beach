          ...
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Ax Palm Beach operates with an unwavering commitment to outperform competitors and expand its presence in
                the executive placement market. Through our innovative AX-RPO system, companies gain a clear competitive
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Through this innovative system, Ax Palm Beach has elevated the globally recognized Recruitment Process
