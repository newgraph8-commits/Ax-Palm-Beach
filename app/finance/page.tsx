        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Palm Beach delivers an executive search experience designed for efficiency, impact, and long-term
              ...
              <div className="flex-1">
                ...
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    adaptable. Ax Palm Beach addresses this need by prioritizing versatility and leadership strength in
                    every search, identifying top-tier executives capable of guiding institutions through both current
