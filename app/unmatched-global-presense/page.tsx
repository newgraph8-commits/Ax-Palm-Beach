...
export const metadata = {
  title: "Unmatched Global Presence - Ax Palm Beach",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    For example, in our growing education division, Ax Palm Beach maintains trusted relationships with
                    school presidents, deans, vice chairs, chancellors, athletic directors, and other key administrators
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ax Palm Beach's expert team prides itself on being just a phone call—or discreet meeting—away from placing
                  a highly qualified executive in front of influential decision-makers.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Through a structured, detail-driven approach, Ax Palm Beach begins by collaborating closely with clients
                  to understand their vision for each critical role—spanning sectors such as education, entertainment,
