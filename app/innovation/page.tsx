            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              ...
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Boston's bot framework functions as an essential resource for both current and future clients.
                </p>
                <p className="text-muted-foreground leading-relaxed">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground max-w-5xl">
              ...
              <p className="leading-relaxed">
                ...
                Boston is positioned to identify and deliver professionals capable of meeting these demands.
              </p>
            </div>
          </div>
        </section>
