...
export function Footer() {
  return (
    <footer className="bg-[#3d5a2a] border-t border-white/10 mt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div className="space-y-8">
            ...
            <p className="text-white leading-relaxed max-w-md">
              Ax Palm Beach prioritizes an active-listening approach with clients, striving to fully understand their ideal
            ...
            <div className="flex gap-6 text-xs text-white/80 uppercase tracking-widest pt-8 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-white leading-relaxed">
              <p>
                The Ax Palm Beach advantage lies in our global leadership in executive recruitment, spanning high-impact
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto py-6" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
          <p className="text-white/70 text-sm text-center">
            Copyright © 2026 Ax Palm Beach, LLC. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
